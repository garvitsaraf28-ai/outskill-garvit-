...
export const STAGES = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "The two masterminds (free workshops)", items: ["Generalist — Sat/Sun, for non-technical people", "Engineering — Friday 7–11pm & Saturday 10am–6pm, for coders (Python is a must)", "~12–14 hrs, free — where we pitch the Bootcamp + Accelerator"] },
    ],
    quiz: [
      { q: "On which days and timings is the Engineering mastermind conducted?", options: ["Saturday 10am–6pm & Sunday 10am–6pm", "Monday & Tuesday, 7pm–11pm", "Friday 7pm–11pm & Saturday 10am–6pm", "Sunday only, 9am–5pm"], answer: 2 },
      { q: "In the funnel, what sits at MOFU (the middle)?", options: ["The Accelerator", "Mastermind + Bootcamp", "Fellowship + Catalyst", "Nothing"], answer: 0 },
      { q: "Is prior Python knowledge compulsory to attend the Engineering mastermind?", options: ["No — it is designed for non-technical people", "Only for the final hackathon", "It is optional but recommended", "Yes — it is built for technical folks comfortable with Python"], answer: 3 },
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Engineering mastermind", items: ["For coders — Python is a must (Friday 7–11pm & Saturday 10am–6pm)", "Spot who routes to the Engineering track", "Watch the full recording below"] },
  ...
  },
  {
    ...
    quiz: [
      { q: "How does Indian EMI work for the learner?", options: ["A 9% fee is added", "Interest is charged monthly", "EMI isn't available in India", "Zero-cost — OutSkill bears the interest"], answer: 3 },
      { q: "An INTERNATIONAL learner wants installments. What applies?", options: ["A 9% convenience fee is added (via XP)", "Zero-cost EMI", "No installments allowed", "Pay via Pine Labs"], answer: 0 },
      { q: "India, no credit card, fails the Shopse eligibility check — the route is…", options: ["Refuse EMI", "Razorpay only", "NBFC partners Fibe / Propel via a Google form", "Just charge 9%"], answer: 2 },
  ...
  },
  {
    ...
    quiz: [
      { q: "Who is the audience for these sales calls?", options: ["Mastermind attendees who did NOT pay", "Cold leads from ads", "Existing Accelerator students", "Random website visitors"], answer: 0 },
      { q: "In the 8-step flow, what comes right after the warm intro?", options: ["Pitch the Accelerator", "Ask for payment", "Ask why they attended the mastermind", "Handle objections"], answer: 2 },
      { q: "Before you pitch, you should first…", options: ["Quote the price", "Offer a discount", "Send the brochure", "Understand their goals and why they didn't pay"], answer: 3 },
